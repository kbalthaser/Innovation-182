...
public class OpenInfobuttonResponderController {
    ...
    public void setIndexPropertyInterpretationMap(
            Map<String, Map<String, String>> indexPropertyInterpretationMap) {
    ...
    private void setRequiredObjects() {
        ...
        if (this.indexPropertyInterpretationMap == null) {
            this.indexPropertyInterpretationMap = responderService
    ...
    public String openInfobuttonRequestHandler(HttpServletRequest request,
            HttpServletResponse response, ModelMap model)
            throws MissingServletRequestParameterException, HttpMediaTypeNotSupportedException,
        ...
        Collection<Asset> matchedAssets = responderService
                .findAssetsByInfobuttonRequest(requestParameters);
        ...
        if (viewType == null) { // default
            ...
            throw new HttpMediaTypeNotSupportedException("Unsupported knowledgeResponseType: "
                    + viewType);
        }
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Missing required parameter(s): mainSearchCriteria.c.c, mainSearchCriteria.c.cs, or taskContext.c.c")
    // 400
